        ...
        <Container>
            <main className="mt-9 mb-2">
                <div className="flex items-center gap-3">
                    <Link href="/dashboard" className="bg-gray-900 text-white px-4 py-1 rounded">Voltar</Link>
...

                    {
                        customers.length === 0 && (
                            <Link href="/dashboard/customer/new">
                                Você ainda não tem cliente. <span className="text-blue-500 font-medium">Cadastre um cliente</span>
                            </Link>
                        )
                    }
